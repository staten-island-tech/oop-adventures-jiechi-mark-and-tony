...
class RouletteWheel:
    def __init__(self, inventory):
        ...
        self.balance = inventory.gambling_balance
        self.bet = 50
...
def main():
    ...
    # Define hitboxes for buttons
    withdraw_button_rect = pygame.Rect(20, 100, 400, 150)  # Moved down and left
    deposit_button_rect = pygame.Rect(ROULETTE_WIDTH - 420, 200, 400, 150)  # Moved down and right
    ...
    while True:
        ...
        screen.blit(input_text_surface, (400, 350))
        ...
        # Draw the deposit button
        pygame.draw.rect(screen, (0, 0, 255), deposit_button_rect)
        deposit_button_text = font.render("Deposit", True, (255, 255, 255))
        screen.blit(deposit_button_text, (deposit_button_rect.x + 10, deposit_button_rect.y + 30))

        # Draw the withdraw button
        pygame.draw.rect(screen, (255, 0, 0), withdraw_button_rect)
        withdraw_button_text = font.render("Withdraw", True, (255, 255, 255))
        screen.blit(withdraw_button_text, (withdraw_button_rect.x + 10, withdraw_button_rect.y + 30))
